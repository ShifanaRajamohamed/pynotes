...
AUTHOR          = 'Shifana'  # use your name
SITENAME        = 'My Python Notes' # use title
GITHUB_USERNAME = 'ShifanaRajamohamed' # use your username
...
# Social widget
SOCIAL = (
    ("GitHub", "https://github.com/ShifanaRajamohamed/"),
    ("LinkedIn", "shifana-rajamohamed"),
)
